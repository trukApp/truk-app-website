    ...
    <>
      ...
      <Grid>
        ...
        <Typography variant="body1" color="text.secondary">
          View and manage your fleet of vehicles. Add new vehicles, update
          details like cost, insurance, registration, and permits, and monitor
                    ...
                    <Grid container spacing={2}>
                      ...
                      <Grid item xs={12} sm={6} md={1.6}>
                        <TextField
                          ...
                          onBlur={handleBlur}
                          error={
                            touched.registration && Boolean(errors.registration)
                          }
                          helperText={
