...
const OrdersGrid: React.FC = () => {
	...
	const formatCreateDate = (createDate: string) =>
		moment(createDate).format('MMM DD, YYYY h:mm A');
			...
			>
				<Grid item>
					...
					<Typography variant="body1">
						Review and manage all aspects
						of your order including General
						Data, Partner Details, Delivery
