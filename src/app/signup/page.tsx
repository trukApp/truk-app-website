...
//     const handleSubmit = (values: FormValues, { setSubmitting, setErrors }: any) => {
...
export default function SignUpPage() {
    ...
    const handleSubmit = (values: FormValues, { setSubmitting, setErrors }: FormikHelpers<FormValues>): void => {
