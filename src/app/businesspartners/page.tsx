...
const BusinessPartnersPage: React.FC = () => {
  ...
  return (
    <Grid sx={{ margin: { xs: "18px 3px", md: "10px 30px" } }}>
      <Grid sx={{ mb: 3 }}>
        <Typography variant="h6" fontWeight="bold" gutterBottom color="primary">
          Business Partners Management
        </Typography>
        <Typography variant="body2" color="text.secondary">
          Select and Manage Different Types of Business Partners Such as
          Customers, Vendors, Carriers, and Drivers. Each Partner Type has its
          Own Form For Detailed Information And Setup.
        </Typography>
      </Grid>
