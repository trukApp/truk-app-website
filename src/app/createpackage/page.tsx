...
const CreatePackage = () => {
  ...
  >("success");
  const [createPackageOrder, { isLoading: isPackageCreating }] =
  ...
  const handleSubmit = async (
    ...
    formikHelpers: FormikHelpers<CreatePackageFormValues>,
  ) => {
    console.log(
      "Submitting eWayBillFile field:",
      values.additionalInfo.eWayBillFile,
    );
    ...
    try {
      ...
      if (typeof error === "object" && error !== null) {
        ...
        if (
          typeof msg === "string" &&
          msg.startsWith(
            "All products in a package must have the same stacking factor",
          )
        ) {
    ...
    <div>
      ...
      {modalOpen && (
        <Dialog open={modalOpen} onClose={() => setModalOpen(false)}>
          ...
          <DialogContent>
            <Typography>
              Your Package Has Been Created Successfully. What Would You Like to
              do Next?
            </Typography>
          </DialogContent>
          <DialogActions>
