      ...
      <section className="bg-white">
        ...
        <Carousel autoPlay interval={3000} animation="fade">
          {[
            {
              image:
                "https://res.cloudinary.com/impargo-gmbh/image/upload/v1666107021/trucker_apps_IMPARGO_2022_01_6e28388ce8.jpg",
              text: "TrukApp made my shipping process so smooth!",
            },
            {
              image:
                "https://static.vecteezy.com/system/resources/previews/035/769/294/non_2x/delivery-truck-and-smartphone-with-navigation-app-png.png",
          ...
          <div className="relative z-10 grid md:grid-cols-2 gap-10 items-center">
            ...
            <div>
              ...
              <p className="text-lg md:text-xl text-gray-700 mt-6 max-w-xl">
                Discover a seamless and secure way to move your goods with
                real-time tracking, best quotes, and easy booking – all in one
                place.
              </p>
        ...
        <section className="py-24 px-6 bg-gradient-to-b from-pink-100 to-purple-200">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <motion.p
              ...
              viewport={{ once: true }}
            >
              TrukApp provides an efficient and reliable way to transport your
              cargo across India. With our trusted carrier network, real-time
              updates, and competitive pricing, your logistics experience is now
              hassle-free.
            </motion.p>
          </div>
          ...
          /> */}
            ...
            >
              ...
              <p className="text-gray-700">
                Our partner network includes top-rated carriers ensuring safety
                and timeliness of your cargo.
              </p>
              <h3 className="text-xl font-semibold text-purple-800">
                Real-Time Tracking
              </h3>
              <p className="text-gray-700">
                Stay updated with driver geo-location and cargo status in
                real-time.
              </p>
              <h3 className="text-xl font-semibold text-purple-800">
                Instant Quotes
              ...
              <p className="text-gray-700">
                Get multiple bids instantly and choose the best deal for your
                shipment.
              </p>
            </motion.div>
          </div>
