export const locationColumnNames = [
  ...
  {
    displayName:
      '"Location Type (Production Plant, Distribution Center, Shipping Point, ...)*"',
    key: "loc_type",
  },
  ...
  {
    displayName: "Contact phone number (10 digits)*",
...
export const vehicleColumnNames = [
  ...
  {
    displayName: "Is Unlimited Usage (if Yes type 1 else 0)",
    key: "unlimited_usage",
  },
  {
    displayName: "Number of Individual Resources (if unlimited is 0 only)",
    key: "individual_resource",
  },
  {
    displayName: "Validity From (dd-mm-yyyy)*",
    key: "validity_from",
    nestedKey: "transportation_details",
  },
  {
    displayName: "Validity To (dd-mm-yyyy)*",
    key: "validity_to",
    nestedKey: "transportation_details",
  },
  {
  ...
  {
    displayName: "Ownership (Self or Carrier)*",
    key: "ownership",
    nestedKey: "transportation_details",
  },
  {
    displayName: "Payload Weight (Numeric)*",
    key: "payload_weight",
    nestedKey: "capacity",
  },
  {
    displayName: "Payload Weight unit (unit only)*",
    key: "payload_weight_unit",
    nestedKey: "capacity",
  },
  {
    displayName: "Cubic Capacity (Numeric)*",
    key: "cubic_capacity",
    nestedKey: "capacity",
  },
  {
    displayName: "Cubic Capacity unit (unit only)*",
    key: "cubic_capacity_unit",
    nestedKey: "capacity",
  },
  {
    displayName: "Interior Length*",
    key: "interior_length",
    nestedKey: "capacity",
  },
  {
    displayName: "Interior Width*",
    key: "interior_width",
    nestedKey: "capacity",
  },
  {
    displayName: "Interior Height*",
    key: "interior_height",
    nestedKey: "capacity",
  },
  {
    ...
    key: "tare_weight",
    nestedKey: "physical_properties",
  },
  {
    displayName: "Max Gross Weight*",
    key: "max_gross_weight",
    nestedKey: "physical_properties",
  },
  {
    displayName: "Tare Volume*",
    key: "tare_volume",
    nestedKey: "physical_properties",
  },
  {
  ...
  {
    displayName: "Downtime Start date (dd-mm-yyyy)*",
    key: "downtime_starts_from",
    nestedKey: "downtimes",
  },
  {
    displayName: "Downtime End date (dd-mm-yyyy)*",
    key: "downtime_ends_from",
    nestedKey: "downtimes",
  },
  {
    displayName: "Downtime Location*",
    key: "downtime_location",
    nestedKey: "downtimes",
  },
  {
    displayName: "Downtime Description*",
    key: "downtime_desc",
    nestedKey: "downtimes",
  },
  { displayName: "Downtime Reason*", key: "reason", nestedKey: "downtimes" },
  {
    displayName: "Cost Per Ton (Rs.)*",
    key: "cost_per_ton",
    nestedKey: "additional_details",
  },
  {
    displayName: "Is Fragile vehicle (if Yes type 1 else 0)",
    key: "fragile_vehicle",
  },
  {
    displayName: "Is Danger proof vehicle (if Yes type 1 else 0)*",
    key: "danger_proof",
  },
  {
    displayName: "Is Hazardous proof vehicle (if Yes type 1 else 0)*",
    key: "hazardous_proof",
  },
  {
    displayName: "Is temperature controlled vehilce (if Yes type 1 else 0)*",
    key: "temp_controlled_vehicle",
  },
];
...
export const laneColumnNames = [
  ...
  { displayName: "Destination Location ID (LOC000001...)*", key: "des_loc_ID" },
  {
    displayName: "Vehicle Type*",
    key: "vehcle_type",
    nestedKey: "lane_transport_data",
  },
  {
    displayName: "Transport Start Date (dd-mm-yyyy)*",
    key: "start_time",
    nestedKey: "lane_transport_data",
  },
  {
    displayName: "Transport End Date (dd-mm-yyyy)*",
    key: "end_time",
    nestedKey: "lane_transport_data",
  },
  {
    displayName: "Transport Distance*",
...
export const carrierColumnNames = [
  ...
  {
    displayName: "Correspondence Name*",
    key: "name",
    nestedKey: "carrier_correspondence",
  },
  {
  ...
  {
    displayName: "Correspondence Phone (10 digits)*",
    key: "phone",
    nestedKey: "carrier_correspondence",
  },
  {
    displayName: "Is enrolled on Carrier Network Portal (if yes type 1 else 0)",
    key: "carrier_network_portal",
  },
  {
    displayName: "Vehicle Types Handling (Van or Truck or...)*",
    key: "vehicle_types_handling",
  },
  {
    displayName: "Carrier Location of Operation (Location ids-(LOC000001...))*",
    key: "carrier_loc_of_operation",
  },
  {
    displayName: "Carrier Lanes (Lane ids-(LN000001...))*",
    key: "carrier_lanes",
  },
];
...
export const customerColumnNames = [
  ...
  { displayName: "Location ID (LOC000001...)*", key: "loc_ID" },
  {
    ...
    key: "contact_person",
    nestedKey: "correspondence",
  },
  {
    displayName: "Contact mobile number (10 digits)*",
    key: "contact_number",
    nestedKey: "correspondence",
  },
  {
    displayName: "Contact Valid Email*",
    key: "email",
    nestedKey: "correspondence",
  },
  {
    displayName: "Location of Source (Location id - (LOC000001...))*",
    key: "loc_of_source",
  },
  {
    displayName: "Is POD Relevant (if Yes type 1 else 0)",
    key: "pod_relevant",
  },
  {
    displayName: "Ship-to Party (Customer id - (CUST000001...))",
    key: "ship_to_party",
    nestedKey: "partner_functions",
  },
  {
    displayName: "Sold-to Party (Customer id - (CUST000001...))",
    key: "sold_to_party",
    nestedKey: "partner_functions",
  },
  {
    displayName: "Bill-to Party (Customer id - (CUST000001...))",
    key: "bill_to_party",
    nestedKey: "partner_functions",
  },
];
...
export const vendorColumnNames = [
  ...
  {
    displayName: "Ordering Address",
    key: "ordering_address",
    nestedKey: "partner_functions",
  },
  {
    displayName: "Goods Supplier",
    key: "goods_supplier",
    nestedKey: "partner_functions",
  },
  {
...
export const driversColumnNames = [
  ...
  { displayName: "*Driver Name", key: "driver_name" },
  {
    ...
    key: "driving_license",
    nestedKey: "driver_correspondence",
  },
  {
    displayName: "*Expiry Date (dd-mm-yyyy)",
    key: "expiry_date",
    nestedKey: "driver_correspondence",
  },
  {
    displayName: "*Driver Contact Number (10 digits)",
    key: "phone",
    nestedKey: "driver_correspondence",
  },
  {
  ...
  {
    displayName: "Is driver available (if Yes type 1 else 0)",
...
export const productColumnNames = [
  ...
  {
    displayName: "Is Packaging Label (if Yes type 1 else 0)",
    key: "packing_label",
  },
  {
    displayName: "Is Fragile Goods (if Yes type 1 else 0)",
    key: "fragile_goods",
  },
  {
    displayName: "Is Dangerous Goods (if Yes type 1 else 0)",
    key: "dangerous_goods",
  },
  { displayName: "Is Hazardous (if Yes type 1 else 0)", key: "hazardous" },
  {
    displayName: "Is Temperature Controlled (if Yes type 1 else 0)",
    key: "temp_controlled",
  },
  {
    displayName: "Packaging Type ID (PKG000001...)*",
    key: "pac_ID",
    nestedKey: "packaging_type",
  },
  {
    displayName: "Location id (LOC000001...)*",
    key: "location",
    nestedKey: "packaging_type",
  },
];
...
export const createPackageOrderColumnNames = [
  ...
  // Geo Fencing
  { displayName: "Geo Fencing Radius*", key: "geo_fencing_radius" },
  { displayName: "Geo Fencing Unit*", key: "geo_fencing_unit" },

  // Product Details
  { displayName: "Product IDs*", key: "prod_IDs" },
  { displayName: "Quantities*", key: "quantities" },
  { displayName: "Package Infos*", key: "package_infos" },

  // Package Master
  { displayName: "Package ID (PKG000001)*", key: "package_info" },
  ...
  {
    displayName: "E-Way Bill File",
    key: "eWay_bill_file",
    nestedKey: "additional_info",
  },
  {
    displayName: "STN/DO Number",
    key: "stn_Do_number",
    nestedKey: "additional_info",
  },
  ...
  // Pickup / Dropoff
  {
    displayName: "Pickup Date Time (yyyy-mm-dd hh:mm)",
    key: "pickup_date_time",
  },
  {
    displayName: "Dropoff Date Time (yyyy-mm-dd hh:mm)",
    key: "dropoff_date_time",
  },
];
