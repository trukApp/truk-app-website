...
const CustomerForm: React.FC = () => {
    ...
    const displayLocations = searchKey === "" ?  getAllLocations : filteredLocations?.searchLocations?.results || [] ;
    ...
    const { loading:filteredDestinationLoading,  data:destinationFilteredLocations } = useQuery(SEARCH_LOCATIONS, {
    ...
    const customersData = data?.getBusinessPartners?.partners.length > 0 ? data?.getBusinessPartners?.partners : []
