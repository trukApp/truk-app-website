...
//   const { data: filteredProductsData, isFetching: isFilteredLoading } = useGetFilteredProductsQuery(
//     searchKey.length >= 3 ? searchKey : null,
...
//                     value={
//                       allProductList.find((p: Product) => p.product_ID === item.productId) || null
//                     }
...
//                     <TextField
//                       value={
//                         (item as any)[fieldName === "RFID-EPC Code" ? "rfid" : fieldName] || ""
//                       }
//                       onChange={(e) =>
//                         setFieldValue(
//                           `packageDetails.${index}.${fieldName === "RFID-EPC Code" ? "rfid" : fieldName
//                           }`,
//                           e.target.value
//                         )
//                       }
