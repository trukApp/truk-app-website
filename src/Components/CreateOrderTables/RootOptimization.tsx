...
//             const filteredRoutes = rootOptimization.flatMap(vehicle =>
//                 vehicle.allocations
//                     .filter(allocation => allocation.transportNumber === selectedTransport)
//                     .flatMap(allocation => allocation.route)
//             );
//             console.log('Filtered Routes for Transport:', selectedTransport, filteredRoutes);
//         }
...
//         filteredRoutes.forEach((r, routeIndex) => {
//             if (!r.start || !r.end) return;
