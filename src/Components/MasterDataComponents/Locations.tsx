...
const Locations: React.FC = () => {
  ...
  const [postLocation, { isLoading: postLocationLoading }] =
    usePostLocationMasterMutation();
    ...
    try {
      ...
      if (isEditing && editRow) {
        ...
        if (response?.updated_record) {
          setSnackbarMessage(
            `Location ID ${response.updated_record} updated successfully!`,
          );
          formik.resetForm();
          setShowForm(false);
          setIsEditing(false);
        ...
        if (response?.created_records) {
          setSnackbarMessage(
            `Location ID ${response.created_records[0]} created successfully!`,
          );
          formik.resetForm();
          setShowForm(false);
          setIsEditing(false);
  ...
  const handleDelete = async (row: DataGridRow) => {
    ...
    try {
      ...
      if (response.data.deleted_record) {
        setSnackbarMessage(
          `Location ID ${response.data.deleted_record} deleted successfully!`,
        );
  ...
  const rows =
    locationsMaster?.map((location: Location) => ({
  ...
  return (
    <Grid>
      <Backdrop
        ...
        open={
          postLocationLoading || editLocationLoading || deleteLocationLoading
        }
      >
          ...
          >
            <Grid container spacing={2} padding={2}>
                ...
                <Grid item xs={12} sm={6} md={2.4}>
                  <TextField
                    ...
                    error={
                      ...
                      Boolean(errors.locationDescription)
                    }
                    helperText={
              ...
              <Grid container spacing={2} mt={1} sx={{ marginLeft: "3px" }}>
                <Typography gutterBottom>Geographical data</Typography>
                <Grid container spacing={2}>
                  <Grid item xs={12} sm={6} md={2.4}>
                    <TextField
                      fullWidth
                ...
                <Grid container spacing={2}>
                  <Grid item xs={12} sm={6} md={2.4}>
                    <TextField
                      ...
                      onBlur={handleBlur}
                      error={
                        touched.locationContactName &&
                        Boolean(errors.locationContactName)
                      }
                      helperText={
                        touched.locationContactName &&
                        errors.locationContactName
                      }
                    />
                  </Grid>
                  <Grid item xs={12} sm={6} md={2.4}>
                    <TextField
                      ...
                      onBlur={handleBlur}
                      error={
                        touched.locationContactNumber &&
                        Boolean(errors.locationContactNumber)
                      }
                      helperText={
                        touched.locationContactNumber &&
                  ...
                  <Grid item xs={12} sm={6} md={2.4}>
                    <TextField
                      ...
                      onBlur={handleBlur}
                      error={
                        touched.locationContactEmail &&
                        Boolean(errors.locationContactEmail)
                      }
                      helperText={
                        touched.locationContactEmail &&
                        errors.locationContactEmail
                      }
                    />
                  </Grid>
                </Grid>
            ...
            <Grid sx={{ marginTop: "24px", textAlign: "center" }}>
              <CustomButtonFilled>
