...
const VehicleForm: React.FC = () => {
  ...
  const [editRow, setEditRow] = useState<VehicleEditValues | null>(null);
  ...
  const [
    deleteVehicle,
    { isLoading: deleteVehicleLoading, error: deleteVehicleError },
  ] = useDeleteVehicleMasterMutation();
  ...
  const getLocationDetails = (loc_IDs: string[]): string => {
    ...
    const detailsList = loc_IDs
      .map((id) => {
        const location = getAllLocations.find(
          (loc: Location) => loc.loc_ID === id,
        );
  ...
  const handleEdit = (row: VehicleEditValues) => {
    setShowForm(true);
    setIsEditing(true);
    setEditRow(row);
  };
            ...
            >
              {({
                ...
                const handleTareChange = (
                  ...
                  const newUnit = e.target.value;
                  setFieldValue("maxLengthUnits", newUnit);
                  setFieldValue("maxWidthUnits", newUnit);
                    ...
                    <Grid>
                      ...
                      <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} sm={6} md={4.8}>
                          ...
                          <Grid mt={1} display="flex" flexWrap="wrap" gap={1}>
                            {Array.isArray(values.locationId) &&
                      ...
                      <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} sm={6} md={2.4}>
                          <TextField
                            ...
                            onBlur={handleBlur}
                            error={
                              touched.vehicleGroup &&
                              Boolean(errors.vehicleGroup)
                            }
                            helperText={
                        ...
                        <Grid item xs={12} sm={6} md={2.4}>
                          <TextField
                            ...
                            onBlur={handleBlur}
                            error={
                              touched.ownership && Boolean(errors.ownership)
                            }
                      ...
                      <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} sm={6} md={1.6}>
                          <TextField
                            ...
                            onBlur={handleBlur}
                            error={
                              touched.maxLength && Boolean(errors.maxLength)
                            }
                        ...
                        <Grid item xs={12} sm={6} md={1.6}>
                          <TextField
                            ...
                            onBlur={handleBlur}
                            error={
                              touched.maxHeight && Boolean(errors.maxHeight)
                            }
